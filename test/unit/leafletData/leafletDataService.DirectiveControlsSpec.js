describe('leafletData directiveControls', function() {
  ...
  beforeEach(function() {
    ...
    testRunner = function(postRunnerCb, preRunnerCb) {
      var element;
      var preRunnerRet;
  ...
  describe('markers controls', function() {
    beforeEach(function() {
      scope.rootName = 'markers';
    });

    describe('exists', function() {
      it('root', function() {
        testRunner(function(controls) {
          expect(controls[scope.rootName]).toBeDefined();
        });
      });

      it('create', function() {
        testRunner(function(controls) {
          return expect(controls[scope.rootName].create).toBeDefined();
        });
      });

      it('clean', function() {
        testRunner(function(controls) {
          return expect(controls[scope.rootName].clean).toBeDefined();
        });
      });
    });
  });

  describe('geojson controls', function() {
    beforeEach(function() {
      scope.rootName = 'geojson';
    });
    ...
    describe('exists', function() {
      ...
      it('create', function() {
        testRunner(function(controls) {
          expect(controls[scope.rootName].create).toBeDefined();
        });
      });

      it('clean', function() {
        testRunner(function(controls) {
          expect(controls[scope.rootName].clean).toBeDefined();
        });
      });
    });
  });
