...
angular.module("leaflet-directive").directive('markers',
    ["$log", "$rootScope", "$q", "$compile", "leafletData", "leafletHelpers", "leafletMapDefaults", "leafletMarkersHelpers", "leafletEvents", "leafletIterators", function ($log, $rootScope, $q, $compile, leafletData, leafletHelpers, leafletMapDefaults, leafletMarkersHelpers,
