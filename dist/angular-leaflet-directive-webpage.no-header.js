...
AppController.$inject = ["$router", "$scope", "$location", "$http", "$q", "$interval", "$rootScope", "$window", "Examples"];
  ...
  return {
    ...
    link: function(scope, element, attrs) {
      scope.$watch('source', function(source) {
        ...
        var compiled = $compile('<div ng-controller="' + ctlr + '">' + body.innerHTML.replace('height="480px"', 'height="360px"') + '</div>')(scope);
...
var app = angular.module('webapp');
      ...
      app.controller("BasicGeoJSONUpdateController", [ '$scope', '$http', 'leafletData', function($scope, $http, leafletData) {
        ...
        app.controller('BasicHideShowMapController', ["$scope", "$timeout", "leafletData", function($scope, $timeout, leafletData) {
            $scope.center = {
                lat: 35,
                lng: 0,
                zoom: 8
    ...
    app.controller('MixedMOverlaysMarkersNestedNoWatchController', ["$scope", "leafletData", "$timeout", function ($scope, leafletData, $timeout) {
        var _clonedMarkers;
        $timeout(function () {
    ...
    app.controller("MixedMarkersNestedEventsController", ["$scope", "leafletEvents", function ($scope, leafletEvents) {
        ...
        app.controller("PathEventsController", ["$scope", "leafletLogger", function($scope, leafletLogger) {
            var paths = {};
            $scope.clicked = 0;
            var marylandIslands = {
                'Fort Carroll': {
        ...
        app.controller("PathEventsWithIDController", ["$scope", "leafletLogger", function($scope, leafletLogger) {
            var paths = {};
            $scope.clicked = 0;
            var marylandIslands = {
                'Fort Carroll': {
        ...
        LocationDataService.$inject = ["$http"];;
        ...
        app.controller('PathsChangeInGroupLayerController', ["$scope", "leafletData", function($scope, leafletData) {
...
ExamplesController.$inject = ["$routeParams", "$http", "Examples"];

var app = angular.module('webapp.exlist', []);
...
ExlistController.$inject = ["$q", "$http", "Examples"];
