...
There is a lot of room for contributions to Esri Leaflet. Make sure you checkout the [development instructions](https://github.com/Esri/esri-leaflet-clustered-feature-layer#development-instructions) in the readme to help you get started.
...
2. `cd` into the `esri-leaflet-clustered-feature-layer` folder
