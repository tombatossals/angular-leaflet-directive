            ...
            if (mustBeLoaded) {
                ...
                for (i in baselayers) {
                    if (isDefined(leafletLayers.baselayers[i])) {
                        var doNotInclude = leafletLayers.baselayers[i].options && isDefined(leafletLayers.baselayers[i].options.layerSelector) && !leafletLayers.baselayers[i].options.layerSelector;
                        if(!doNotInclude) {
