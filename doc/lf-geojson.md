...
It will map an object _layers_ of our controller scope with the corresponding object on our directive isolated scope. It's a bidirectional relationship, so we could change our _layers_ scope object to change dinamically the layers of the map.
